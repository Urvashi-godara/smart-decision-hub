...
import bgGeometric from "@/assets/bg-geometric-glow.jpg";
...
const FeaturesSection = () => (
  <SectionBackground image={bgGeometric} opacity={0.12} overlay="darker">
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {features.map((f, i) => (
            ...
            >
              <div className="w-12 h-12 rounded-lg bg-primary/10 flex items-center justify-center mb-4 group-hover:bg-primary/20 group-hover:shadow-[0_0_20px_hsla(173,80%,50%,0.15)] transition-all duration-500">
